...
function TorinoRestaurantsMap() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        __turbopack_context__.r("[project]/src/utils/fixLeafletIcon.ts [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
        const query = `
      [out:json][timeout:25];
    ...
    `;
        fetch('https://overpass-api.de/api/interpreter', {
            ...
            }).filter((el)=>el.lat && el.lon && el.name).slice(0, 50); // prendi solo i primi 50
